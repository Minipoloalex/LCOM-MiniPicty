...
int (setup_menu)(state_t *state) {
  ...
  button_t play_button = {x, height, width, height, NOT_HOVERED_BG_COLOR, "PLAY", NOTHING, enter_game};  
  button_t settings_button = {x, height * 3, width, height, NOT_HOVERED_BG_COLOR, "LEADERBOARD", NOTHING, enter_game};
  button_t exit_button = {x, height * 5, width, height, NOT_HOVERED_BG_COLOR, "EXIT", NOTHING, enter_game};
