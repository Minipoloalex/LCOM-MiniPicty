...
int (game_process_mouse)() {
  ...
  // button_hovered = is_cursor_over_game_button(next.position);
  // if (pressed_button != -1 && pressed_button == button_hovered 
  // && !next.is_drawing && before.is_drawing) {
  //   printf("clicking on button %d\n", pressed_button);
  //   game_buttons[button_hovered].onClick(&game_buttons[button_hovered]);
  //   ser_add_button_click_to_transmitter_queue(button_hovered);
  //   pressed_button = -1;
  // }
